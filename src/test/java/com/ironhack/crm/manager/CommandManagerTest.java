...
class CommandManagerTest {
    ...
    public void setCommandList_ValidCommand_OneOfTheCommands() {
        ...
        assertEquals("Lookup Opportunity <id> : Shows an Opportunity.", commandList.get(3));
        assertEquals("Close-Won <id> : Closes an Opportunity as won.", commandList.get(4));
        assertEquals("Close-Lost <id> : Closes an Opportunity as lost.", commandList.get(5));
        assertEquals("Exit : Closes the CRM.", commandList.get(6));
